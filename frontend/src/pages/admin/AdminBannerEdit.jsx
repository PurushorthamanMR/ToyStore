...
export default function AdminBannerEdit() {
  ...
  async function handleSubmit(e) {
    ...
    setSaving(true);
    try {
      await api.put(`/banners/${id}`, { image });
  ...
  if (!found) return <p className="text-gray-700 dark:text-gray-300">Banner not found.</p>;

  return (
    <AdminDetailLayout title="Edit Banner">
      <form
