...
import { faCoins, faReceipt, faBox, faUsers } from '@fortawesome/free-solid-svg-icons';
...
export default function AdminDashboard() {
  ...
  if (!stats) return <p className="text-gray-500 dark:text-gray-400">Failed to load dashboard.</p>;
